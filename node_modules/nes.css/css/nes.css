...
.nes-container.is-float-left{
  float: left;
}

.nes-container.is-float-right{
  float: right;
}
...
.nes-container.with-title.is-centered.is-float-left > .title {
  margin: -2rem auto 1rem;
}

.nes-container.with-title.is-centered.is-float-right > .title {
  margin: -2rem auto 1rem;
}
